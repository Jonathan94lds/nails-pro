    ...
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <div className="px-4 py-4 pb-28 space-y-5">
          ...
          {cargandoDashboard ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-white border border-[#EFEAE2] rounded-3xl p-4">
                <p className="text-[#8A8378] text-xs">Ingresos totales (mes actual)</p>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className={`${utilidad >= 0 ? 'bg-[#2F4A3C]' : 'bg-[#B8623A]'} rounded-3xl p-4 text-white`}>
            <p className="text-white/70 text-xs">Utilidad</p>
            <p className="text-lg font-semibold mt-1" style={{ fontFamily: 'Fraunces, Georgia, serif' }}>${utilidad.toLocaleString()}</p>
          </div>
        </div>
